...
| SUNNXT | **Prefetch expected** (fixes 0.5.33, field verify pending) | hls.js with browser-rendered native cues — no caption DOM exists. Native-textTracks harvest (0.5.31) supplies cues; 0.5.33 hides originals via `video::cue`, opens the prefetch gate at ≥10 native cues, filters mnemonic UI labels. First channel-1-only site |
