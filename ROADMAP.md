...
| Translation quality pass — **queued next** | Glossary for recurring names/terms, previous line as context for pronoun consistency (quote/preamble stripping already shipped) | Easy–medium |
